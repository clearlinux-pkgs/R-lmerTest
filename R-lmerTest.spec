...
Source0  : https://cran.r-project.org/src/contrib/lmerTest_3.1-3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603466387
...
/usr/lib64/R/library/lmerTest/tests/test_contrast_utils.R
