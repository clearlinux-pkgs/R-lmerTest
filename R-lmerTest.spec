...
Version  : 3.0.1
Release  : 2
URL      : https://cran.r-project.org/src/contrib/lmerTest_3.0-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lmerTest_3.0-1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530307035
